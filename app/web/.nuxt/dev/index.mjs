globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///usr/src/app/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'http';
import { tmpdir } from 'os';
import { join } from 'path';
import { mkdirSync } from 'fs';
import { parentPort, threadId } from 'worker_threads';
import { provider, isWindows } from 'file:///usr/src/app/node_modules/std-env/dist/index.mjs';
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener, getQuery, createError } from 'file:///usr/src/app/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///usr/src/app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///usr/src/app/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///usr/src/app/node_modules/vue/server-renderer/index.mjs';
import { parseURL, withQuery, joinURL } from 'file:///usr/src/app/node_modules/ufo/dist/index.mjs';
...
import { createFetch as createFetch$1, Headers } from 'file:///usr/src/app/node_modules/ofetch/dist/node.mjs';
...
import { createStorage } from 'file:///usr/src/app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///usr/src/app/node_modules/unstorage/dist/drivers/fs.mjs';
import defu from 'file:///usr/src/app/node_modules/defu/dist/defu.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/usr/src/app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/usr/src/app/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/usr/src/app/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/usr/src/app/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  if (!res) {
    const { template } = await import('file:///usr/src/app/node_modules/@nuxt/ui-templates/dist/templates/error-dev.mjs') ;
    {
...
const getClientManifest = () => import('/usr/src/app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/usr/src/app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
